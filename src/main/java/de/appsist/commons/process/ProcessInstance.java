package de.appsist.commons.process;
...
public interface ProcessInstance {
	...
	/**
	 * Returns the process instance on top of the process instantiation tree.
	 * @return Process instance. <code>this</code> if not instantiated by another process. 
	 */
	public ProcessInstance getTopMostParent();
	...
	/**
	 * Terminates the process instance. All parent instances will also be terminated.
	 */
	public void terminate();
	
	/**
	 * Cancels the process instance on user request.
	 */
	public void cancel();
