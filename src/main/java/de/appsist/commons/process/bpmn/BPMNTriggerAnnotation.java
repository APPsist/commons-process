...
/**
 * Wrapper for BPMN annotations as specified in appsist:bpmn:annotations for <code>trigger</code> elements. 
...
public class BPMNTriggerAnnotation implements TriggerAnnotation {
	 ...
	 * @param triggerElement XML element as specified in appsist:bpmn:annotations for <code>trigger</code> elements.
	 */
	...
	public BPMNTriggerAnnotation(String eventId, Map<String, Object> references) {
		triggerElement = new Element("trigger", BPMNNamespace.APPSIST);
	 ...
	 * @return XML data structure as specified for <code>trigger</code> in appsist:bpmn:annotations.
	 */
	...
	public Map<String, Object> getReferences() {
		...
		Element referencesElement = triggerElement.getChild("references", BPMNNamespace.APPSIST);
