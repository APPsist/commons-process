...
/**
 * Implementation for APPsist event annotations in a BPMN model.
...
public class BPMNEventAnnotation implements EventAnnotation {
	 ...
	 * @param eventElement XML element as specified in appsist:bpmn:annotations for events.
	 */
	...
	public BPMNEventAnnotation(String eventId, Type eventType, Map<String, Object> properties) {
		eventElement = new Element("event", BPMNNamespace.APPSIST);
	...
	public Map<String, Object> getProperties() {
		Element propertiesElement = eventElement.getChild("properties", BPMNNamespace.APPSIST);
